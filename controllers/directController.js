...
module.exports={
    ...
    gotoFeatures(req, res) {
        res.render('pages/features', { title: "Features" ,logInUser: Register});
    },
    gotoExtra(req, res) {
        res.render('pages/extra', { title: "Dashboard",data:"test" ,logInUser: Register});
    },
    gotoAbout(req, res) {
        res.render('pages/about', { title: "About", data: "About",logInUser: Register});
    },
    async gotoTable(req, res) {
        const data = await Recipe.find({})
        res.render('pages/recipesTable', { title: "Recipes", data:data ,logInUser: Register});
    },
    gotoInventory(req,res){
        res.render('pages/inventory',{title:"Inventory",data:"data",logInUser: Register})
    },
